...
// Vendored from: https://github.com/uppinote20/claude-dashboard (MIT License)
// Source: dist/check-usage.js @ v1.8.1
// Notes: This file is executed inside Docker with a temporary HOME to isolate credential usage checks.
...
var OAUTH_CLIENT_ID = process.env.GEMINI_OAUTH_CLIENT_ID || "";
var OAUTH_CLIENT_SECRET = process.env.GEMINI_OAUTH_CLIENT_SECRET || "";
...
async function refreshTokenInternal(credentials) {
  try {
    ...
    if (!OAUTH_CLIENT_ID || !OAUTH_CLIENT_SECRET) {
      debugLog("gemini", "refreshTokenInternal: missing OAuth client id/secret; skipping refresh");
      return null;
    }
